		              								...
		              								<TBODY>
										              	...
										              	<TR>
										                	<TD style="HEIGHT: 28px">验证码：</TD>
										               	 	<TD style="HEIGHT: 28px"><INPUT id=txtcode style="WIDTH: 130px" name="valCode"></TD>
										                	<TD style="HEIGHT: 28px">&nbsp;</TD></TR>
										              	<TR>
										                	<TD style="HEIGHT: 18px"></TD>
										                	<TD style="HEIGHT: 18px">
										                		<img onclick="changeCode(this)" src="${pageContext.request.contextPath }/user_createCode"/>
										                		
										                		<script type="text/javascript">
										                			function changeCode(img){
										                				//需求就是改变验证码，---再请求一次就可以改变了。 
										                				img.src="${pageContext.request.contextPath }/user_createCode?a="+new Date();
										                			}
										                		</script>
										                	</TD>
										                	<TD style="HEIGHT: 18px"></TD>
